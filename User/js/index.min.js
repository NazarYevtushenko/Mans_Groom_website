...
(() => {
      ...
      764: function(e) {
        e.exports = function() {
          ...
          const e = "SweetAlert2:",
            ...
            Te = {},
            Se = () => {
              Te.previousActiveElement && Te.previousActiveElement.focus ? (Te.previousActiveElement.focus(), Te.previousActiveElement = null) : document.body && document.body.focus()
            },
            xe = e => new Promise((t => {
              if (!e) return t();
            ...
            Oe = () => {
              const e = L(),
                ...
                a = le(e, k.textarea);
              t.oninput = Pe, n.onchange = Pe, o.onchange = Pe, r.onchange = Pe, a.oninput = Pe, s.oninput = () => {
                Pe(), i.value = s.value
              }, s.onchange = () => {
            ...
            Be = e => {
              const t = ke();
              if (ye()) return void o("SweetAlert2 requires document to initialize");
              const n = document.createElement("div");
              n.className = k.container, t && re(n, k["no-transition"]), Q(n, Ee);
              const s = Ae(e.target);
            ...
            Ne = (e, t) => {
              const n = q(),
                s = G();
              t.showConfirmButton || t.showDenyButton || t.showCancelButton ? de(n) : ue(n), ne(n, t, "actions"), He(n, s, t), Q(s, t.loaderHtml), ne(s, t, "loader")
            };
          ...
          function He(e, t, n) {
            const s = N(),
              i = H(),
              o = V();
            Ge(s, "confirm", n), Ge(i, "deny", n), Ge(o, "cancel", n), _e(s, i, o, n), n.reverseButtons && (n.toast ? (e.insertBefore(o, s), e.insertBefore(i, s)) : (e.insertBefore(o, t), e.insertBefore(i, t), e.insertBefore(s, t)))
          }

          function _e(e, t, n, s) {
            if (!s.buttonsStyling) return ae([e, t, n], k.styled);
            re([e, t, n], k.styled), s.confirmButtonColor && (e.style.backgroundColor = s.confirmButtonColor, re(e, k["default-outline"])), s.denyButtonColor && (t.style.backgroundColor = s.denyButtonColor, re(t, k["default-outline"])), s.cancelButtonColor && (n.style.backgroundColor = s.cancelButtonColor, re(n, k["default-outline"]))
          }

          function Ge(e, t, s) {
            he(e, s["show".concat(n(t), "Button")], "inline-block"), Q(e, s["".concat(t, "ButtonText")]), e.setAttribute("aria-label", s["".concat(t, "ButtonAriaLabel")]), e.className = k[t], ne(e, s, "".concat(t, "Button")), re(e, s["".concat(t, "ButtonClass")])
          }

          function Ve(e, t) {
            "string" == typeof t ? e.style.background = t : t || re([document.documentElement, document.body], k["no-backdrop"])
          }

          function qe(e, t) {
            t in k ? re(e, k[t]) : (i('The "position" parameter is not valid, defaulting to "center"'), re(e, k.center))
          }
          ...
          const We = (e, t) => {
            const n = O();
            n && (Ve(n, t.backdrop), qe(n, t.position), Fe(n, t.grow), ne(n, t, "container"))
          };
          var Re = {
            ...
            et = (e, t, n) => {
              if (n.inputLabel) {
                ...
                const s = document.createElement("label"),
                  i = k["input-label"];
                s.setAttribute("for", e.id), s.className = i, re(s, n.customClass.inputLabel), s.innerText = n.inputLabel, t.insertAdjacentElement("beforebegin", s)
              }
            },
            tt = e => {
          ...
          const st = (e, t) => {
            ...
            ot = (e, t) => {
              const n = R();
              Q(n, t.closeButtonHtml), ne(n, t, "closeButton"), he(n, t.showCloseButton), n.setAttribute("aria-label", t.closeButtonAriaLabel)
            },
            rt = (e, t) => {
              const n = Re.innerParams.get(e),
                s = B();
              return n && t.icon === n.icon ? (ut(s, t), void at(s, t)) : t.icon || t.iconHtml ? t.icon && -1 === Object.keys(P).indexOf(t.icon) ? (o('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), ue(s)) : (de(s), ut(s, t), at(s, t), void re(s, t.showClass.icon)) : ue(s)
            },
            at = (e, t) => {
              for (const n in P) t.icon !== n && ae(e, P[n]);
              re(e, P[t.icon]), pt(e, t), lt(), ne(e, t, "icon")
            },
            lt = () => {
              const e = L(),
            ...
            ut = (e, t) => {
              e.textContent = "", t.iconHtml ? Q(e, ht(t.iconHtml)) : "success" === t.icon ? Q(e, ct) : "error" === t.icon ? Q(e, dt) : Q(e, ht({
                question: "?",
                warning: "!",
                info: "i"
              } [t.icon]))
            ...
            ht = e => '<div class="'.concat(k["icon-content"], '">').concat(e, "</div>"),
            mt = (e, t) => {
              const n = D();
            ...
            gt = e => {
              const t = document.createElement("li");
              return re(t, k["progress-step-line"]), e.progressStepsDistance && (t.style.width = e.progressStepsDistance), t
            },
            vt = (e, t) => {
              const n = j();
              ...
              de(n), n.textContent = "", t.currentProgressStep >= t.progressSteps.length && i("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(((e, s) => {
                const i = ft(e);
                if (n.appendChild(i), s === t.currentProgressStep && re(i, k["active-progress-step"]), s !== t.progressSteps.length - 1) {
                  const e = gt(t);
                  n.appendChild(e)
                }
              }))
            ...
            bt = (e, t) => {
              const n = $();
              he(n, t.title || t.titleText, "block"), t.title && $e(t.title, n), t.titleText && (n.innerText = t.titleText), ne(n, t, "title")
            },
            wt = (e, t) => {
              const n = O(),
                s = L();
              t.toast ? (ce(n, "width", t.width), s.style.width = "100%", s.insertBefore(G(), B())) : ce(s, "width", t.width), ce(s, "padding", t.padding), t.color && (s.style.color = t.color), t.background && (s.style.background = t.background), ue(z()), yt(s, t)
            },
            yt = (e, t) => {
              e.className = "".concat(k.popup, " ").concat(me(e) ? t.showClass.popup : ""), t.toast ? (re([document.documentElement, document.body], k["toast-shown"]), re(e, k.toast)) : re(e, k.modal), ne(e, t, "popup"), "string" == typeof t.customClass && re(e, t.customClass), t.icon && re(e, k["icon-".concat(t.icon)])
            },
            Ct = (e, t) => {
              wt(e, t), We(e, t), vt(e, t), rt(e, t), mt(e, t), bt(e, t), ot(e, t), st(e, t), Ne(e, t), it(e, t), "function" == typeof t.didRender && t.didRender(L())
            },
            Tt = Object.freeze({
              cancel: "cancel",
              backdrop: "backdrop",
            ...
            Pt = e => {
              ...
              return s(e.querySelectorAll("swal-param")).forEach((e => {
                ...
                "boolean" == typeof h[n] && "false" === s && (t[n] = !1), "object" == typeof h[n] && (t[n] = JSON.parse(s))
              })), t
            },
            Ot = e => {
              const t = {};
            ...
            Bt = (e, t) => {
              ...
              for (const s in t) {
                const i = t[s],
                  o = e.querySelector(i);
                o && (It(o, []), n[i.replace(/^swal-/, "")] = o.innerHTML.trim())
              }
              return n
            },
            $t = e => {
          ...
          function Nt(e) {
            jt(e), e.showLoaderOnConfirm && !e.preConfirm && i("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"), zt(e), "string" == typeof e.title && (e.title = e.title.split("\n").join("<br />")), Be(e)
          }
          class Ht {
            constructor(e, t) {
          ...
          const _t = () => {
            ...
            Vt = () => {
              if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1) && !ee(document.body, k.iosfix)) {
                ...
                document.body.style.top = "".concat(-1 * e, "px"), re(document.body, k.iosfix), Ft(), qt()
              }
            },
            qt = () => {
            ...
            Kt = e => {
              ...
              en(t, n, e), setTimeout((() => {
                Jt(t, n)
              }), Ut), U() && (Qt(t, e.scrollbarPadding, s), St()), K() || Te.previousActiveElement || (Te.previousActiveElement = document.activeElement), "function" == typeof e.didOpen && setTimeout((() => e.didOpen(n))), ae(t, k["no-transition"])
            },
            Zt = e => {
              const t = L();
              if (e.target !== t) return;
              const n = O();
              t.removeEventListener(je, Zt), n.style.overflowY = "auto"
            },
            Jt = (e, t) => {
              je && ve(t) ? (e.style.overflowY = "hidden", t.addEventListener(je, Zt)) : e.style.overflowY = "auto"
            },
            Qt = (e, t, n) => {
              Vt(), t && "hidden" !== n && _t(), setTimeout((() => {
                e.scrollTop = 0
              }))
            },
            en = (e, t, n) => {
              ...
              }), Ut), re([document.documentElement, document.body], k.shown), n.heightAuto && n.backdrop && !n.toast && re([document.documentElement, document.body], k["height-auto"])
            },
            tn = e => {
              let t = L();
              t || new Ws, t = L();
            ...
            nn = (e, t) => {
              const n = q(),
                s = G();
              !t && me(N()) && (t = N()), de(n), t && (ue(t), s.setAttribute("data-button-to-replace", t.className)), s.parentNode.insertBefore(s, t), re([e, n], k.loading)
            },
            sn = (e, t) => {
              "select" === t.input || "radio" === t.input ? cn(e, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (d(t.inputValue) || p(t.inputValue)) && (tn(N()), dn(e, t))
            },
            on = (e, t) => {
              const n = e.getInput();
              if (!n) return null;
            ...
            cn = (e, t) => {
              ...
              d(t.inputOptions) || p(t.inputOptions) ? (tn(N()), u(t.inputOptions).then((t => {
                e.hideLoading(), s(t)
              }))) : "object" == typeof t.inputOptions ? s(t.inputOptions) : o("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof t.inputOptions))
            },
            dn = (e, t) => {
              const n = e.getInput();
            ...
            un = {
              select: (e, t, n) => {
                const s = le(e, k.select),
                  i = (e, t, s) => {
                    ...
                    i.value = s, Q(i, t), i.selected = hn(s, n.inputValue), e.appendChild(i)
                  };
                t.forEach((e => {
                  const t = e[0],
                    n = e[1];
              ...
              radio: (e, t, n) => {
                ...
                t.forEach((e => {
                  ...
                  o.type = "radio", o.name = k.radio, o.value = t, hn(t, n.inputValue) && (o.checked = !0);
                  const a = document.createElement("span");
                  Q(a, i), a.className = k.label, r.appendChild(o), r.appendChild(a), s.appendChild(r)
                }));
          ...
          function bn(e, t, n, s) {
            K() ? On(e, s) : (xe(n).then((() => On(e, s))), Te.keydownTarget.removeEventListener("keydown", Te.keydownHandler, {
              capture: Te.keydownListenerCapture
            }), Te.keydownHandlerAdded = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), U() && (Gt(), Xt(), xt()), wn()
          }
          ...
          const Tn = e => {
            ...
            const s = O();
            return ae(s, n.showClass.backdrop), re(s, n.hideClass.backdrop), kn(e, t, n), !0
          };
          ...
          const xn = e => {
            ...
            Pn = (e, t, n, s, i) => {
              Te.swalCloseEventFinishedCallback = bn.bind(null, e, n, s, i), t.addEventListener(je, (function(e) {
                e.target === t && (Te.swalCloseEventFinishedCallback(), delete Te.swalCloseEventFinishedCallback)
              }))
            },
            On = (e, t) => {
              setTimeout((() => {
          ...
          function Dn(e) {
            ...
            Q(t.validationMessage, e), t.validationMessage.className = k["validation-message"], n.customClass && n.customClass.validationMessage && re(t.validationMessage, n.customClass.validationMessage), de(t.validationMessage);
            const s = this.getInput();
            s && (s.setAttribute("aria-invalid", !0), s.setAttribute("aria-describedby", k["validation-message"]), ie(s), re(s, k.inputerror))
          }
          ...
          function Nn(e) {
            ...
            const s = Hn(e),
              o = Object.assign({}, n, s);
            Ct(this, o), Re.innerParams.set(this, o), Object.defineProperties(this, {
              params: {
          ...
          function _n() {
            ...
            t ? (e.popup && Te.swalCloseEventFinishedCallback && (Te.swalCloseEventFinishedCallback(), delete Te.swalCloseEventFinishedCallback), Te.deferDisposalTimer && (clearTimeout(Te.deferDisposalTimer), delete Te.deferDisposalTimer), "function" == typeof t.didDestroy && t.didDestroy(), Gn(this)) : Vn(this)
          }
          const Gn = e => {
              Vn(e), delete e.params, delete Te.keydownHandler, delete Te.keydownTarget, delete Te.currentInstance
            },
            Vn = e => {
              e.isAwaitingPromise() ? (qn(Re, e), Re.awaitingPromise.set(e, !0)) : (qn(vn, e), qn(Re, e))
            },
            qn = (e, t) => {
          ...
          const Wn = e => {
            ...
            Yn = (e, t) => {
              e.disableButtons(), t(Tt.cancel)
            },
            Xn = (e, t) => {
              const s = Re.innerParams.get(e);
              if (!s.input) return o('The "input" parameter is needed to be set when using returnInputValueOn'.concat(n(t)));
              const i = on(e, s);
            ...
            Kn = (e, t) => {
              ...
              n.showLoaderOnDeny && tn(H()), n.preDeny ? (Re.awaitingPromise.set(e || void 0, !0), Promise.resolve().then((() => u(n.preDeny(t, n.validationMessage)))).then((n => {
            ...
            Qn = (e, t) => {
              ...
              n.showLoaderOnConfirm && tn(), n.preConfirm ? (e.resetValidationMessage(), Re.awaitingPromise.set(e || void 0, !0), Promise.resolve().then((() => u(n.preConfirm(t, n.validationMessage)))).then((n => {
                me(z()) || !1 === n ? (e.hideLoading(), xn(e)) : Zn(e, void 0 === n ? t : n)
              })).catch((t => Jn(e || void 0, t)))) : Zn(e, t)
            },
            es = (e, t, n) => {
              Re.innerParams.get(e).toast ? ts(e, t, n) : (is(t), os(t), rs(e, t, n))
            },
            ts = (e, t, n) => {
              t.popup.onclick = () => {
                const t = Re.innerParams.get(e);
                t && (ns(t) || t.timer || t.input) || n(Tt.close)
              }
            },
          ...
          const is = e => {
            ...
            rs = (e, t, n) => {
              t.container.onclick = s => {
                ...
                ss ? ss = !1 : s.target === t.container && c(i.allowOutsideClick) && n(Tt.backdrop)
              }
            },
            as = () => me(L()),
            ls = () => N() && N().click(),
            ...
            fs = (e, t, n) => {
              const s = Re.innerParams.get(e);
              s && (t.isComposing || 229 === t.keyCode || (s.stopKeydownPropagation && t.stopPropagation(), "Enter" === t.key ? gs(e, t, s) : "Tab" === t.key ? vs(t, s) : [...hs, ...ms].includes(t.key) ? bs(t.key) : "Escape" === t.key && ws(t, s, n)))
            },
            gs = (e, t, n) => {
            ...
            bs = e => {
              ...
              const t = hs.includes(e) ? "nextElementSibling" : "previousElementSibling";
              let n = document.activeElement;
              for (let e = 0; e < q().children.length; e++) {
                if (n = n[t], !n) return;
                if (me(n) && n instanceof HTMLButtonElement) break
              }
              n instanceof HTMLButtonElement && n.focus()
            },
            ws = (e, t, n) => {
              c(t.allowEscapeKey) && (e.preventDefault(), n(Tt.esc))
            },
            ...
            Ts = e => {
              ...
              return "object" != typeof e[0] || Cs(e[0]) ? ["title", "html", "icon"].forEach(((n, s) => {
                const i = e[s];
                "string" == typeof i || Cs(i) ? t[n] = i : void 0 !== i && o("Unexpected type of ".concat(n, '! Expected "string" or "Element", got ').concat(typeof i))
          ...
          const Es = () => Te.timeout && Te.timeout.getTimerLeft(),
            ks = () => {
            ...
            Ms = () => Te.timeout && Te.timeout.isRunning();
          let Ls = !1;
          const Bs = {};
          ...
          class zs {
            ...
            _main(e) {
              let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
              S(Object.assign({}, t, e)), Te.currentInstance && (Te.currentInstance._destroy(), U() && xt()), Te.currentInstance = this;
              const n = Hs(e, t);
              Nt(n), Object.freeze(n), Te.timeout && (Te.timeout.stop(), delete Te.timeout), clearTimeout(Te.restoreFocusTimeout);
              const s = _s(this);
              return Ct(this, n), Re.innerParams.set(this, n), Ns(this, s, n)
            }
            then(e) {
          ...
          const Ns = (e, t, n) => new Promise(((s, i) => {
              const o = t => {
                e.closePopup({
                  isDismissed: !0,
                  dismiss: t
              ...
              vn.swalPromiseResolve.set(e, s), vn.swalPromiseReject.set(e, i), t.confirmButton.onclick = () => Wn(e), t.denyButton.onclick = () => Rn(e), t.cancelButton.onclick = () => Yn(e, o), t.closeButton.onclick = () => o(Tt.close), es(e, t, o), us(e, Te, n, o), sn(e, n), Kt(n), Gs(Te, n, o), Vs(t, n), setTimeout((() => {
            ...
            Hs = (e, t) => {
              ...
              return s.showClass = Object.assign({}, h.showClass, s.showClass), s.hideClass = Object.assign({}, h.hideClass, s.hideClass), s
            },
            _s = e => {
              const t = {
                popup: L(),
            ...
            Vs = (e, t) => {
              if (!t.toast) return c(t.allowEnterKey) ? void(qs(e, t) || ps(t, -1, 1)) : Fs()
            },
            qs = (e, t) => t.focusDeny && me(e.denyButton) ? (e.denyButton.focus(), !0) : t.focusCancel && me(e.cancelButton) ? (e.cancelButton.focus(), !0) : !(!t.focusConfirm || !me(e.confirmButton) || (e.confirmButton.focus(), 0)),
            Fs = () => {
              document.activeElement instanceof HTMLElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()
            };
          Object.assign(zs.prototype, Fn), Object.assign(zs, Ds), Object.keys(Fn).forEach((e => {
            zs[e] = function() {
              if (js) return js[e](...arguments)
            }
          })), zs.DismissReason = Tt, zs.version = "11.4.4";
          const Ws = zs;
  ...
  n.n = e => {
    ...
    function b(e, t = "x") {
      ...
      return n.WebKitCSSMatrix ? (i = r.transform || r.webkitTransform, i.split(",").length > 6 && (i = i.split(", ").map((e => e.replace(",", "."))).join(", ")), o = new n.WebKitCSSMatrix("none" === i ? "" : i)) : (o = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), s = o.toString().split(",")), "x" === t && (i = n.WebKitCSSMatrix ? o.m41 : 16 === s.length ? parseFloat(s[12]) : parseFloat(s[4])), "y" === t && (i = n.WebKitCSSMatrix ? o.m42 : 16 === s.length ? parseFloat(s[13]) : parseFloat(s[5])), i || 0
    }
      ...
      for (let i = 1; i < e.length; i += 1) {
        ...
        if (null != o && (s = o, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
          ...
          for (let n = 0, s = e.length; n < s; n += 1) {
            ...
            void 0 !== i && i.enumerable && (w(t[s]) && w(o[s]) ? o[s].__swiper__ ? t[s] = o[s] : y(t[s], o[s]) : !w(t[s]) && w(o[s]) ? (t[s] = {}, o[s].__swiper__ ? t[s] = o[s] : y(t[s], o[s])) : t[s] = o[s])
          }
        }
      }
      var s;
    ...
    function P(e = {}) {
      return x || (x = function({
        ...
        const u = i.match(/(iPod)(.*OS\s([\d_]+))?/),
          ...
          h = "Win32" === s;
        let m = "MacIntel" === s;
        return !d && m && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${r}x${l}`) >= 0 && (d = i.match(/(Version)\/([\d.]+)/), d || (d = [0, 1, "13_0_0"]), m = !1), c && !h && (o.os = "android", o.android = !0), (d || p || u) && (o.os = "ios", o.ios = !0), o
      }(e)), x
    }
      ...
      updateSlides: function() {
        ...
        for (let i = 0; i < u; i += 1) {
          ...
          if (x && e.grid.updateSlide(i, r, u, t), "none" !== r.css("display")) {
            ...
            d[i] && (d[i].swiperSlideSize = E), m.push(E), s.centeredSlides ? (y = y + E / 2 + T / 2 + w, 0 === T && 0 !== i && (y = y - o / 2 - w), 0 === i && (y = y - o / 2 - w), Math.abs(y) < .001 && (y = 0), s.roundLengths && (y = Math.floor(y)), S % s.slidesPerGroup == 0 && p.push(y), h.push(y)) : (s.roundLengths && (y = Math.floor(y)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && p.push(y), h.push(y), y = y + E + w), e.virtualSize += E + w, T = E, S += 1
          }
        }
        ...
        if (Object.assign(e, {
          ...
          C(e.wrapperEl, "--swiper-centered-offset-before", -p[0] + "px"), C(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
      ...
      translateTo: function(e = 0, t = this.params.speed, n = !0, s = !0, i) {
        ...
        if (d = s && e > l ? l : s && e < c ? c : e, o.updateProgress(d), r.cssMode) {
          ...
          if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -d;
            ...
            if (!o.support.smoothScroll) return T({
              swiper: o,
              targetPosition: -d,
              side: e ? "left" : "top"
            }), !0;
    ...
    const $ = {
      slideTo: function(e = 0, t = this.params.speed, n = !0, s, i) {
        ...
        return o.setTransition(t), o.setTranslate(v), o.updateActiveIndex(r), o.updateSlidesClasses(), o.emit("beforeTransitionStart", t, s), o.transitionStart(n, b), 0 === t ? o.transitionEnd(n, b) : o.animating || (o.animating = !0, o.onSlideToWrapperTransitionEnd || (o.onSlideToWrapperTransitionEnd = function(e) {
      ...
      slideNext: function(e = this.params.speed, t = !0, n) {
        ...
        return r.rewind && s.isEnd ? s.slideTo(0, e, t, n) : s.slideTo(s.activeIndex + l, e, t, n)
      },
      slidePrev: function(e = this.params.speed, t = !0, n) {
        ...
        let m = 0;
        return void 0 !== h && (m = a.indexOf(h), m < 0 && (m = s.activeIndex - 1), "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && (m = m - s.slidesPerViewDynamic("previous", !0) + 1, m = Math.max(m, 0))), i.rewind && s.isBeginning ? s.slideTo(s.slides.length - 1, e, t, n) : s.slideTo(m, e, t, n)
      },
      ...
      slideToClickedSlide: function() {
        ...
        if (t.loop) {
          ...
          i = parseInt(f(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? o < e.loopedSlides - s / 2 || o > e.slides.length - e.loopedSlides + s / 2 ? (e.loopFix(), o = n.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), g((() => {
            e.slideTo(o)
          }))) : e.slideTo(o) : o > e.slides.length - s ? (e.loopFix(), o = n.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), g((() => {
            e.slideTo(o)
          }))) : e.slideTo(o)
        } else e.slideTo(o)
      }
    ...
    function D(e) {
      ...
      !!r.noSwipingClass && "" !== r.noSwipingClass && d.target && d.target.shadowRoot && e.path && e.path[0] && (u = f(e.path[0]));
      ...
      if (Object.assign(i, {
          ...
          isScrolling: void 0,
          startMoving: void 0
        }), l.startX = m, l.startY = g, i.touchStartTime = v(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, r.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== d.type) {
        let e = !0;
    ...
    function j(e) {
      ...
      if (void 0 === s.isScrolling) {
        let e;
        n.isHorizontal() && r.currentY === r.startY || n.isVertical() && r.currentX === r.startX ? s.isScrolling = !1 : h * h + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(h)) / Math.PI, s.isScrolling = n.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle)
      }
      ...
      r.diff = g, g *= i.touchRatio, a && (g = -g), n.swipeDirection = g > 0 ? "prev" : "next", s.currentTranslate = g + s.startTranslate;
      let b = !0,
        w = i.resistanceRatio;
    ...
    function z(e) {
      ...
      if (d > s.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (m >= s.longSwipesRatio ? t.slideTo(p + f) : t.slideTo(p)), "prev" === t.swipeDirection && (m > 1 - s.longSwipesRatio ? t.slideTo(p + f) : t.slideTo(p))
      } else {
    ...
    const q = (e, t) => {
      ...
      (s.preventClicks || s.preventClicksPropagation) && r[u]("click", e.onClick, !0), s.cssMode && a[u]("scroll", e.onScroll), s.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N, !0) : e[p]("observerUpdate", N, !0)
    };
    const F = {
        attachEvents: function() {
          ...
          e.onTouchStart = D.bind(e), e.onTouchMove = j.bind(e), e.onTouchEnd = z.bind(e), n.cssMode && (e.onScroll = _.bind(e)), e.onClick = H.bind(e), s.touch && !G && (t.addEventListener("touchstart", V), G = !0), q(e, "on")
        },
    ...
    const R = {
      ...
      getBreakpoint: function(e, t = "window", n) {
        ...
        for (let e = 0; e < r.length; e += 1) {
          ...
          "window" === t ? i.matchMedia(`(min-width: ${a}px)`).matches && (s = o) : a <= n.clientWidth && (s = o)
        }
        return s || "max"
      }
    };
    ...
    const K = {
        ...
        images: {
          loadImage: function(e, t, n, s, i, o) {
            ...
            f(e).parent("picture")[0] || e.complete && i ? c() : t ? (l = new r.Image, l.onload = c, l.onerror = c, s && (l.sizes = s), n && (l.srcset = n), t && (l.src = t)) : c()
          },
    ...
    class J {
      constructor(...e) {
        ...
        const o = y({}, X, i);
        return s.params = y({}, o, Z, n), s.originalParams = y({}, s.params), s.passedParams = y({}, n), s.params && s.params.on && Object.keys(s.params.on).forEach((e => {
    ...
    Object.keys(K).forEach((e => {
      ...
      t("init", (() => {
        ...
        })), i.observe(e.el)) : (s.addEventListener("resize", o), s.addEventListener("orientationchange", r))
      })), t("destroy", (() => {
        i && i.unobserve && e.el && (i.unobserve(e.el), i = null), s.removeEventListener("resize", o), s.removeEventListener("orientationchange", r)
      }))
    }, function({
      swiper: e,
      extendParams: t,
    ...
    function ee(e, t, n, s) {
      ...
      return e.params.createElements && Object.keys(s).forEach((o => {
        if (!n[o] && !0 === n.auto) {
          ...
          r || (r = i.createElement("div"), r.className = s[o], e.$el.append(r)), n[o] = r, t[o] = r
        }
      })), n
    }
    ...
    function se(t) {
      for (var n = 1; n < arguments.length; n++) {
        ...
        n % 2 ? ne(Object(s), !0).forEach((function(n) {
          e(t, n, s[n])
        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(s)) : ne(Object(s)).forEach((function(e) {
    ...
    Q.use([function({
      ...
      t({
        ...
        if (e.params.navigation.hideOnClick && !f(r).is(o) && !f(r).is(i)) {
      ...
      function c() {
        ...
        if (e.params.loop ? (d = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), d > i - 1 - 2 * e.loopedSlides && (d -= i - 2 * e.loopedSlides), d > u - 1 && (d -= u), d < 0 && "bullets" !== e.params.paginationType && (d = u + d)) : d = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === n.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
          ...
          let i, a, u;
          if (n.dynamicBullets && (o = s.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), c.css(e.isHorizontal() ? "width" : "height", o * (n.dynamicMainBullets + 4) + "px"), n.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (r += d - (e.previousIndex - e.loopedSlides || 0), r > n.dynamicMainBullets - 1 ? r = n.dynamicMainBullets - 1 : r < 0 && (r = 0)), i = Math.max(d - r, 0), a = i + (Math.min(s.length, n.dynamicMainBullets) - 1), u = (a + i) / 2), s.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${n.bulletActiveClass}${e}`)).join(" ")), c.length > 1) s.each((e => {
            const t = f(e),
              s = t.index();
        ...
        if ("fraction" === n.type && (c.find(te(n.currentClass)).text(n.formatFractionCurrent(d + 1)), c.find(te(n.totalClass)).text(n.formatFractionTotal(u))), "progressbar" === n.type) {
          ...
          let i = 1,
            o = 1;
          "horizontal" === t ? i = s : o = s, c.find(te(n.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${o})`).transition(e.params.speed)
        }
      ...
      function d() {
        ...
        if ("bullets" === t.type) {
          ...
          i.html(o), e.pagination.bullets = i.find(te(t.bulletClass))
        }
      ...
      e.autoplay = {
        ...
        if (e.params.autoplay.enabled) {
          a();
          o().addEventListener("visibilitychange", d), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", p), e.$el.on("mouseleave", h))
        }
    ...
    const ae = function(t, n) {
      oe().fire(function(t) {
        for (var n = 1; n < arguments.length; n++) {
          var s = null != arguments[n] ? arguments[n] : {};
          n % 2 ? re(Object(s), !0).forEach((function(n) {
            e(t, n, s[n])
          })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(s)) : re(Object(s)).forEach((function(e) {
            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(s, e))
          }))
        }
        return t
    ...
    function ce() {
      window.pageYOffset > 300e3 && !le && (ae({
